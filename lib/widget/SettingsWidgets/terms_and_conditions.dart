      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            children: [
              Text(
                  "These terms and conditions applies to the bon Appetit app (hereby referred to as 'Application') for mobile devices that was created by Antony Kiran (hereby referred to as 'Service Provider') as a Free service.",
              ...
              TextButton(
                onPressed: () async {
                  ...
                  if (await canLaunchUrl(Uri.parse(url))) {
                    ...
                    // Optionally, add some error handling code here, such as showing a SnackBar
              ...
              Text(
                  ...
                  style: TextStyle(fontSize: 16, fontFamily: 'Kanit')),
              SizedBox(height: 10),
              Text("These terms and conditions are effective as of 2024-05-06",
                  style: TextStyle(fontSize: 16, fontFamily: 'Kanit')),
              SizedBox(height: 10),

    ...
    return Scaffold(
      ...
      Stack(children: [
        SizedBox(
            height: 280,
            child: Center(
                child: Image.asset('lib/assets/title.png', fit: BoxFit.fill))),
        Positioned(
            top: 200,
            left: 0,
            right: 0,
      ...
      Visibility(
          ...
          child: const Padding(
              padding: EdgeInsets.all(8.0), child: ScreenSignup())),
      Visibility(
          visible: showSignInContainer,
          child:
              const Padding(padding: EdgeInsets.all(8.0), child: SignInForm())),
    ]))));
  }
}
